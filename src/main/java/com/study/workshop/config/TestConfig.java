...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order firstOrder = new Order(null, Instant.parse("2026-01-20T19:20:15Z"), firstUser);
		Order secondOrder = new Order(null, Instant.parse("2026-01-13T10:20:15Z"), secondtUser);
